...
const PrivacyPolicy = () => {
	return (
		<div className="privacyPolicy-wrapper">
			<h1 className="privacyPolicy-title">Политика конфиденциальности</h1>
			<div className="privacyPolicy-body">
				<p className="privacyPolicy-item">
				...
				<p className="privacyPolicy-item">
					...
					предпринимаемые Калашников Денис Олегович (далее — Оператор).
				</p>{" "}
				<p className="privacyPolicy-item">
				...
				<p className="privacyPolicy-item">
					...
					Оператор может получить о посетителях веб-сайта https://neurocast.ru.
				</p>{" "}
				<p className="privacyPolicy-item">
				...
				<p className="privacyPolicy-item">
					...
					в сети интернет по сетевому адресу https://neurocast.ru.
				</p>{" "}
				<p className="privacyPolicy-item">
				...
				<p className="privacyPolicy-item">
					2.10. Пользователь — любой посетитель веб-сайта https://neurocast.ru.
				</p>{" "}
				<p className="privacyPolicy-item">
				...
				<p className="privacyPolicy-item">
					...
					данные; — в случае отзыва субъектом персональных данных согласия
					...
					о персональных данных; — самостоятельно определять состав и перечень
				...
				<p className="privacyPolicy-item">
					...
					в течение 10 дней с даты получения такого запроса; — публиковать или
				...
				<p className="privacyPolicy-item">
					...
					данных; — требовать от оператора уточнения его персональных данных,
				...
				<p className="privacyPolicy-item">
					6. Цели обработки персональных данных Цель обработкиуточнение деталей
					заказаПерсональные данные фамилия, имя, отчество электронный адрес
					номера телефонов Правовые основания договоры, заключаемые между
					оператором и субъектом персональных данных Виды обработки персональных
					данных Сбор, запись, систематизация, накопление, хранение, уничтожение
				...
				<p className="privacyPolicy-item">
					...
					Оператора Neurocastprod@gmail.com с пометкой «Актуализация
					персональных данных».
				</p>{" "}
				<p className="privacyPolicy-item">
					...
					Оператора Neurocastprod@gmail.com с пометкой «Отзыв согласия
				...
				<p className="privacyPolicy-item">12. Заключительные положения</p>{" "}
				<p className="privacyPolicy-item">
					...
					к Оператору с помощью электронной почты Neurocastprod@gmail.com.
				</p>{" "}
				<p className="privacyPolicy-item">
				...
				<p className="privacyPolicy-item">
					...
					в сети Интернет по адресу https://neurocast.ru/pk.
				</p>
			</div>
		</div>
	);
